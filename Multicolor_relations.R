setwd("~/AttentionModel Add Relations/DissertationCASPER/data/Multicolor_EMC_30_ATC_2_0.9_0.15_0.001_4rfs_polar_2_NRD")
...
#human_data <- read.csv("~/AttentionModel Add Relations/DissertationCASPER/XO_3_2_data.csv", header=TRUE)
human_data <- read.csv("~/AttentionModel Add Relations/DissertationCASPER/XO_1_2_data.csv", header=TRUE)
