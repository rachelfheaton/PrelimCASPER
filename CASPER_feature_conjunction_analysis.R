setwd("~/AttentionModel Add Relations/DissertationCASPER/data/")
source('~/AttentionModel Add Relations/DissertationCASPER/CASPER_TriesmanGelade_helper_functions.R')
library(tidyverse)
