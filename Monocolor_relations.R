setwd("~/AttentionModel Add Relations/DissertationCASPER/data/Monocolor_EMC_30_ATC_2_0.9_0.15_0.001_4rfs_polar_NRD")
source('~/AttentionModel Add Relations/DissertationCASPER/CASPER_relation_helper_functions.R')
library(tidyverse)
...
human_data <- read.csv("~/AttentionModel Add Relations/DissertationCASPER/XO_2_2_data.csv", header=TRUE)
...
plot_log_curves(plot_df, 'plot_color',
                c("Relation Only", "Relation + Feature", "Feature Only", "Target Only"))

#plot_scatter_curves(dotplot_df, 'plot_color', c("Relation Only", "Relation + Feature", "Feature Only", "Target Only"))
