setwd("~/AttentionModel Add Relations/DissertationCASPER/data/Wolfe_EMC30_ATC_2_0.9_0.15_0.001_4rfs")
source('~/AttentionModel Add Relations/DissertationCASPER/CASPER_Wolfe_helper_functions.R')
library(tidyverse)
...
human_data <- read.csv("~/AttentionModel Add Relations/DissertationCASPER/TriesmanGeladeEstimates.csv", header=TRUE)
human_df <- human_data %>%
  filter(plot_color != 99) 
...
rsq(human_df$RT, nontargetonly_df$RT)
