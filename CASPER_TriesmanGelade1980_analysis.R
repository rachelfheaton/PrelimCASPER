setwd("~/AttentionModel Add Relations/DissertationCASPER/data/TreismanGelade1980_EMC_30_ATC_2_0.9_0.15_0.001_4rfs")
source('~/AttentionModel Add Relations/DissertationCASPER/CASPER_TriesmanGelade1980_helper_functions.R')
library(tidyverse)
...
plot_log_curves(plot_df, 'plot_color',
                c("Color Feature", "Conjunction", "Target Only"))#, "Feature Only", "Target Only"))
...
human_data <- read.csv("~/AttentionModel Add Relations/DissertationCASPER/TriesmanGeladeEstimates2.csv", header=TRUE)
human_df <- human_data %>%
  filter(plot_color != 99) 
