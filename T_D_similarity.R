setwd("~/AttentionModel Add Relations/DissertationCASPER/data/TD_EMC_30_ATC_2_0.9_0.15_0.001_4rfs")
source('~/AttentionModel Add Relations/DissertationCASPER/CASPER_T_D_similarity_helper_functions.R')
library(tidyverse)
...
human_data <- read.csv("~/AttentionModel Add Relations/DissertationCASPER/BuettiHumanData_reformattedforCASPER.csv", header=TRUE)
human_df <- human_data %>%
   filter(plot_color != 99) 
# 
# 
# 
# max_human_setsize = max(human_data$total_setsize)
